...
I needed a script that generates python wrappers for my C++ projects. It is not likely that a CMake generator would fit the need of anyone but I tried to make
it as general as possible so you can tailor the generated CMake files/implementation to your own needs.
